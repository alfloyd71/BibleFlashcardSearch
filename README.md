...
Besides the Django package, pythonbible is the only other dependency all other files are included in the biblefs app folder. django.contrib.humanize needs to be added to installed apps.  
...
## Flashcard App Demo 
Explore the features of our Bible Flashcard App by checking out our custom live demo.  
[Click here to view a customized demo of the Bible Flashcard App](https://www.freesmartphoneapps.com/biblefs/)